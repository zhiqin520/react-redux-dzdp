    ...
    render() {
        ...
        return (
            <div id="home-category">
                <ReactSwipe  ref="reactSwipe" swipeOptions={opt}>
                    <div className="carousel-item">
                        ...
                        <button type="button" className="icon-chevron-left icon-prev" onClick={this.handlePrev}></button>
                        <button type="button" className="icon-angle-right icon-next" onClick={this.handleNext}></button>
                    </div>
                    <div className="carousel-item">
                        <ul className="clear-fix">
                ...
                <div className="index-container">
                    <ul>
                        <li className={this.state.index === 0 ? "selected" : ''} onClick={() => this.handleSlide(0)}></li>
                        <li className={this.state.index === 1 ? "selected" : ''} onClick={() => this.handleSlide(1)}></li>
                        <li className={this.state.index === 2 ? "selected" : ''} onClick={() => this.handleSlide(2)}></li>
                    </ul>
                </div>
            </div>
        )
